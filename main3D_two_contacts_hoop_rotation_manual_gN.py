...
output_path = '/Users/theresahonein/Desktop/terryhonein/Research-HulaHoop/outputs'
def save_arrays():
...
def get_contact_constraints(q,u,a,tau,xbar_hip,vbar_hip,abar_hip):
    ...
    # different constrINT FORMULATION SO THERE ARE VALUE DESCRIPENCIES -- TO CHECK
    # WN0 = np.zeros((1,ndof))
