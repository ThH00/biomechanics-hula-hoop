...
class Simulation:
    def __init__(self, ntime = 5, mu_s=10**9, mu_k=0.3, eN=0, eF=0, max_leaves=5):
        ...
        from contact_constraints_fixed_hip import get_contact_constraints_hyperboloid
        self.get_contact_constraints = get_contact_constraints_hyperboloid.__get__(self)
