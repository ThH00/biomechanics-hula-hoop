...
MAXITERn = 10               # maximum number of Newton iterations per time step
MAXITERn_initial = MAXITERn # saving the initial value of MAXITERn
...
def update(prev_X,prev_AV,prev_q,prev_u,prev_gNdot,prev_gammaF,leaf,*fixed_contact):
    ...
    try:
        ...
        while np.abs(norm_R)>tol_n and nu<MAXITERn:
            # Newton Update
